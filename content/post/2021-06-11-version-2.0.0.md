...
* [Changes to the Framework Core]({{< ref "#core" >}})
* [Implementation of Analytic Electric Fields]({{< ref "#fields" >}})
* [New model for the `CSADigitizer`]({{< ref "#CSADigitizer" >}})
...
As one piece of the puzzle of the full reproducibility of simulations, the C++ STL random number distributions were replaced by the implementation provided with the Boost.Random library.
...
## Model `custom` in `CSADigitizer` {#CSADigitizer}
!455
XXX Simon
