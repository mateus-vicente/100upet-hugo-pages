...
After more than 3.5 years of continuous development and countless feature and patch releases of the {{% allpix %}} 1.x series, we are proud to announce the second major release of the framework, **{{% allpix %}}, version 2.0.0**.
...
* First of all, we would like to extend our gratitude to the by now 34 contributors as well as the countless users for their continued input to the development, be it through actual code or through fruitful discussions and suggestions on the implementation of different features.
