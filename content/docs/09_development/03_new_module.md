...
manager which can be found in [Section 5.3](../../04_framework/04_modules). The basic steps to implement a new module,
...
- The framework documentation in [Chapter 4](../../04_framework) for an introduction to the different components of
  the framework.

- The module documentation in [Chapter 7](../../07_modules) for a description of the functionality of other modules
...
[Section 9.3](../../09_development/03_new_module).
...
5.  A line with `ALLPIX_MODULE_REQUIRE_GEANT4_INTERFACE(${MODULE_NAME})` adds the Geant4 interface library as explained in
    [Section 13.1](../../13_additional/01_tools#geant4-interface).
...
\[[@markdown]\]. It is automatically included in the user manual in [Chapter 7](../../07_modules).
...
[Section 4.6](../../04_framework/06_messages). The constructor should be used to bind required messages, set configuration
